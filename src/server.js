(
  function () {
    ...
    app.post('/ignorePUT', function (req, res) {
      ...
      let options = {
        ...
        headers: {
          ...
          'User-Agent': 'OAuth rChinPoeTrade/1.316.2 (contact: b10121035@gemail.yuntech.edu.tw)',
        },
    ...
    app.post('/api/trade/data/leagues', function (req, res) {
      console.log(moment().format('HH:mm:ss'), "call leagues API")
      console.log(req.body)
      // let url = encodeURI(req.body.url)
      let baseUrl = req.body.baseUrl
      let options = {
        url: `${baseUrl}/api/trade/data/leagues`,
        method: 'get',
        headers: {
          'accept': '*/*',
          'Cookie': req.body.cookie,
    ...
    app.post('/api/trade/data/items', function (req, res) {
      console.log(moment().format('HH:mm:ss'), "call items API")
      console.log(req.body)
      // let url = encodeURI(req.body.url)
      let baseUrl = req.body.baseUrl
      let options = {
        url: `${baseUrl}/api/trade/data/items`,
        method: 'get',
        headers: {
          'accept': '*/*',
          'Cookie': req.body.cookie,
    ...
    app.post('/api/trade/data/stats', function (req, res) {
      console.log(moment().format('HH:mm:ss'), "call stats API")
      console.log(req.body)
      // let url = encodeURI(req.body.url)
      let baseUrl = req.body.baseUrl
      let options = {
        url: `${baseUrl}/api/trade/data/stats`,
        method: 'get',
        headers: {
          'accept': '*/*',
          'Cookie': req.body.cookie,
    ...
    app.post('/api/trade/data/static', function (req, res) {
      console.log(moment().format('HH:mm:ss'), "call static API")
      console.log(req.body)
      // let url = encodeURI(req.body.url)
      let baseUrl = req.body.baseUrl
      let options = {
        url: `${baseUrl}/api/trade/data/static`,
        method: 'get',
        headers: {
          'accept': '*/*',
          'Cookie': req.body.cookie,
    ...
    app.post('/api/trade/fetch', function (req, res) {
    ...
    app.post('/trade', function (req, res) {
      ...
      let options = {
        ...
        headers: {
          'accept': '*/*',
          'Content-Type': 'application/json',
          'User-Agent': 'OAuth rChinPoeTrade/1.316.1 (contact: b10121035@gemail.yuntech.edu.tw)',
        },
        rejectUnauthorized: false,
        requestCert: false,
        agent: false,
      ...
      if (req.body.cookie) {
        options.headers.Cookie = req.body.cookie
      }
